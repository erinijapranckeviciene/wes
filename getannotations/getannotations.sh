...
echo "OMIMD $OMIMD"
myosliceD=`pwd`/static/DB/myoslice
echo "myosliceD  $myosliceD"
...
## Stable link expired: http://grch37.ensembl.org/biomart/martview/7cc764372a19cf10b4ccf750a01a8c02
...
# if myoslice Identifiers folder exists, prep files to import to sqlite3
if [ -d ${myosliceD} ]; then 

##############################################################################mim2gene#########
cat ${myosliceD}/myosliceids.csv  > myoslice.tsv

echo " =======================================================================mart.tsv"
echo ""
head -n4 myoslice.tsv
echo ""
fi
...
# exome based panel IDs
sqlite3 IDDB.db ".mode tabs" ".import myoslice.tsv myosliceids" ".exit"
