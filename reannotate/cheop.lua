...
-- pwd to -change to the current

omimFile  = "pwd/annotation-tables/OmimTable"
gnomadlofFile     = "pwd/annotation-tables/GnomadLofTable"
orphanetFile      = "pwd/annotation-tables/OrphaTable"
