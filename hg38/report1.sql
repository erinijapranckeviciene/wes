...
CREATE TABLE variant_fields_gts_genelevel_nm AS SELECT v.*, gl.NM 
  FROM  variant_fields_gts_genelevel v 
    LEFT JOIN genelevel gl ON v.Ensembl_transcript_id=gl.ENST;
...
## Here we should select in a proper Order again 
SELECT * from variant_fields_gts_genelevel_nm;
