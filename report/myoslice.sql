...
## Load myoslice identifiers
DROP TABLE IF EXISTS myosliceid;
.mode tabs
.headers on
.import /projects/analysis/report/annotations/myosliceid.csv myosliceid
