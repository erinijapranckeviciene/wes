...
my @colToPrint_Part0=("Mainenst","Infoenst");
...
## Aditional fields showing the transcript of interest
print join("\t", @valueByPos{ @colByName{@colToPrint_Part0} } ), "\n";
